...
export default function PricingSection() {
    return (
        <section className="w-full py-24 px-4 md:px-10 bg-[#0a0a0a]">
            {/* ---------- HEADER ---------- */}
            ...
            <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
                ...
                {/* FREE PLAN CARD */}
                <div className="bg-[#131313] rounded-3xl border border-white/10
                    ...
                    <button className="w-full bg-[#222222] text-white py-4 text-sm 
                                       border-t border-white/10 rounded-b-3xl
                ...
                <div className="bg-[#131313] rounded-3xl border border-white/10
                                shadow-[0_0_50px_rgba(0,0,0,0.55)]
                                overflow-hidden flex flex-col justify-between relative">
                    ...
                    <button className="w-full bg-[#b19cff] text-black py-4 text-sm font-medium
                                       hover:bg-[#a68cff] transition-colors rounded-b-3xl">
                        Upgrade to Plus
                    </button>
                </div>
